...
<a className='mt-5 bg-yellow-300 px-1 text-center py-[6.5px] tracking-tight italic hover:bg-yellow-400 rounded-[5px] w-[179px] hover:scale-110 text-black font-sans font-extrabold text-lg  transition-all ease-in duration-75' href="https://applecourses.netlify.app">Back to Apple Shop</a>

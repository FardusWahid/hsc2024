...
<Link className=" matwidth justify-center flex md:w-1/2 lg:w-1/3 xl:w-[410px] md:text-lg italic hover:bg-yellow-600 hover:ring-red-900 hover:ring-1 transition-all ease-in-out duration-150 text-black font-extrabold tracking-wide hover:tracking-widest rounded-md m-auto py-[8px] md:py-[12px] mt-5 bg-yellow-400" href="https://tinyurl.com/windows-destroyer">medical archive 23 & 22&nbsp; <GrDocumentPdf color="black"  size={25}/>
</Link>
